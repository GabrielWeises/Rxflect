    ...
    .p3d_playground {
        ...
        .model {
            ...
            @for $i from 0 through 14 {
                ...
                html : `${hamlArray}] 
-# Criado usando Rxflect by Gabriel Alves
.p3d_playground
    .model
        ...
        newModel() {
            this.voxels = [];
            this.mode = 'drawing';
            $("#colorBg, #exportBg").spectrum("set", '#3f406d');
            $("#colorPicker").spectrum("set", '#ffffff');
            that.exportSettings.bgColor = '#1d1f31';
        ...
        resetBgColor() {
            $("#colorBg, #exportBg").spectrum("set", '#1d1f31');
            this.exportSettings.bgColor = '#1d1f31';
        },
